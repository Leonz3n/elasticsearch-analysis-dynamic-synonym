...
public class RemoteSynonymFile implements SynonymFile {
  ...
  RemoteSynonymFile(Environment env, Analyzer analyzer,
    ...
    this.httpclient = AccessController
        .doPrivileged((PrivilegedAction<CloseableHttpClient>) HttpClients::createDefault);

    isNeedReloadSynonymMap();
  }

  static SynonymMap.Builder getSynonymParser(Reader rulesReader, String format, boolean expand,
  ...
  public boolean isNeedReloadSynonymMap() {
    RequestConfig rc = RequestConfig.custom()
        ...
        .build();
    HttpHead head = AccessController
        .doPrivileged((PrivilegedAction<HttpHead>) () -> new HttpHead(location));
    head.setConfig(rc);
