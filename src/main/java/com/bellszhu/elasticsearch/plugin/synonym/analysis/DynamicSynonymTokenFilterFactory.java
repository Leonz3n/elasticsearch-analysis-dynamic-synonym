...
public class DynamicSynonymTokenFilterFactory extends AbstractTokenFilterFactory {
  ...
  public DynamicSynonymTokenFilterFactory(
    ...
    final TokenizerFactory tokenizerFactory = tokenizerFactoryFactory
        .get(indexSettings, env, tokenizerName, AnalysisRegistry
            .getSettingsFromIndexSettings(indexSettings,
    ...
    Analyzer analyzer = new Analyzer() {
      ...
      protected TokenStreamComponents createComponents(String fieldName) {
        Tokenizer tokenizer =
            tokenizerFactory == null ? new WhitespaceTokenizer() : tokenizerFactory.create();
  ...
  public TokenStream create(TokenStream tokenStream) {
    DynamicSynonymFilter dynamicSynonymFilter = new DynamicSynonymFilter(tokenStream, synonymMap,
        ignoreCase);
